...
export default function StepProfile({ userId, onComplete }: Props) {
  const [education, setEducation] = useState<CollectedData['education_level'] | null>(null);
  const [language, setLanguage] = useState<CollectedData['preferred_language'] | null>(null);
      ...
      <View style={styles.card}>
        ...
        <View style={styles.chipRow}>
          {EDUCATION_OPTIONS.map((o) => (
            ...
            >
              <Text style={[styles.chipText, education === o.value && styles.chipTextActive]}>
                {o.label}
              </Text>
            </Pressable>
          ))}
        ...
        <Text style={styles.label}>School / University name <Text style={styles.optional}>(optional)</Text></Text>
        <TextInput
          style={styles.input}
          value={school}
        ...
        <View style={styles.chipRow}>
          {LANGUAGE_OPTIONS.map((o) => (
            ...
            >
              <Text style={[styles.chipText, language === o.value && styles.chipTextActive]}>
                {o.label}
              </Text>
            </Pressable>
          ))}
...
const styles = StyleSheet.create({
  ...
  title: {
    fontFamily: 'Orbit_400Regular', fontWeight: '700',
    fontSize: 26, color: '#fff', marginBottom: 8,
  },
  subtitle: {
    fontFamily: 'Orbit_400Regular', fontWeight: '300',
    fontSize: 15, color: 'rgba(255,255,255,0.6)', marginBottom: 32,
  },
  label: {
    fontFamily: 'Orbit_400Regular', fontWeight: '600',
    fontSize: 14, color: 'rgba(255,255,255,0.8)', marginBottom: 12,
  },
  ...
  chipText: {
    fontFamily: 'Orbit_400Regular', fontWeight: '500',
  ...
  input: {
    ...
    fontFamily: 'Orbit_400Regular', fontSize: 15,
    marginBottom: 28, backgroundColor: 'rgba(255,255,255,0.05)',
  },
  btn: {
    backgroundColor: '#BFFF00', borderRadius: 100,
