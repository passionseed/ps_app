  ...
  describe("parseSurvivalVerdict", () => {
    it("parses a valid row into CareerSurvival", async () => {
      ...
      expect(result).toEqual({
        ...
        salary_floor: null,
        salary_ceiling: null,
        global_demand_growth: null,
        global_grad_employment_pct: null,
        global_saturation_level: null,
        global_progression_difficulty: null,
        global_salary_floor: null,
        global_salary_ceiling: null,
        metric_details: {},
