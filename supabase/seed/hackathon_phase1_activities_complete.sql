...
values
  ('fa100000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000010', '1min Outcome', 'Start by aligning on the exact outcome Phase 1 should produce.', 0, 1, true, false),
  ('fa100000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000010', '5min Chatbot Interviewee', 'Use the AI interviewee to practice customer discovery with a simulated user.', 1, 5, true, false),
...
values
  ('fb100000-0000-0000-0000-000000000001', 'fa100000-0000-0000-0000-000000000001', 'text', 'Phase 1 outcome', 'By the end of Phase 1 your team should have a validated customer problem, a sharper persona, real interview evidence, and a mentor-ready problem statement.', null, 0, '{"format":"outcome"}'::jsonb),
  ('fb100000-0000-0000-0000-000000000002', 'fa100000-0000-0000-0000-000000000002', 'ai_chat', 'Interview AI', 'Talk to the AI interviewee as if they are your customer. Focus on pain, workflow, and unmet needs.', null, 0, '{"chat_mode":"interviewee"}'::jsonb),
