...
export function getPreviewPhaseWithActivities(phaseId: string): HackathonPhaseWithActivities {
  ...
  return {
    ...
    due_at: phase.due_at,
    activities: [
      { id: "preview-act-1", phase_id: phase.id, title: "Show the Outcome", instructions: "Chat with your future self to see where your path leads.", display_order: 1, estimated_minutes: 20, is_required: true, is_draft: false, submission_scope: "individual" as const, created_at: "", updated_at: "", content: [{ id: "c1", activity_id: "preview-act-1", content_type: "npc_chat", content_title: "Your Future Self", content_url: null, content_body: null, display_order: 1, metadata: {}, created_at: "" }], assessment: { id: "a1", activity_id: "preview-act-1", assessment_type: "text_answer", points_possible: 10, is_graded: true, metadata: {}, created_at: "", updated_at: "" } },
      { id: "preview-act-2", phase_id: phase.id, title: "You Are the Interviewee", instructions: "An AI interviews you to uncover what you truly care about.", display_order: 2, estimated_minutes: 25, is_required: true, is_draft: false, submission_scope: "individual" as const, created_at: "", updated_at: "", content: [{ id: "c2", activity_id: "preview-act-2", content_type: "ai_chat", content_title: "Discovery Interview", content_url: null, content_body: null, display_order: 1, metadata: {}, created_at: "" }], assessment: { id: "a2", activity_id: "preview-act-2", assessment_type: "text_answer", points_possible: 15, is_graded: true, metadata: {}, created_at: "", updated_at: "" } },
